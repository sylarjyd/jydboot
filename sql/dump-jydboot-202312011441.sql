...
CREATE TABLE `t_sys_menu` (
  ...
  `status` int DEFAULT NULL COMMENT '状态 0正常 1锁定',
  `deleted` int DEFAULT NULL COMMENT '删除标记 0正常 1删除',
  `code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '权限编码',
  ...
  `source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '图标',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `sort` int DEFAULT NULL COMMENT '序号',
  `category` int DEFAULT NULL COMMENT '1菜单2按钮3数据',
  `parent_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '父级ID',
  `alias` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '别名',
...
-- Dump completed on 2023-12-01 14:41:06
