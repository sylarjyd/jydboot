...
import { PORTALUSER_SUBMIT } from '../../../actions/portalUser';
...
@Form.create()
class PortalUserAdd extends PureComponent {
  handleSubmit = e => {
    e.preventDefault();
    const { dispatch, form } = this.props;
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        dispatch(PORTALUSER_SUBMIT(values));
      }
    });
  };
  ...
  render() {
    ...
    return (
      <Panel title="新增" back="/jydboot/portalUser" action={action}>
