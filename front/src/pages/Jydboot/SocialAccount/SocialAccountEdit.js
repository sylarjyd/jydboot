...
import { SOCIALACCOUNT_DETAIL, SOCIALACCOUNT_SUBMIT } from '../../../actions/socialAccount';
...
@Form.create()
class SocialAccountEdit extends PureComponent {
  componentWillMount() {
    const {
      dispatch,
      match: {
  ...
  handleSubmit = e => {
    ...
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        console.log(params);
        dispatch(SOCIALACCOUNT_SUBMIT(params));
      }
    });
  };
  ...
  render() {
    ...
    return (
      <Panel title="修改" back="/jydboot/socialAccount" action={action}>
          ...
          <Card className={styles.card} bordered={false}>
            ...
            <FormItem {...formItemLayout} label="社交应用类型，例如qq，weixin">
              {getFieldDecorator('socialCode', {
                ...
                initialValue: detail.socialCode,
            ...
            <FormItem {...formItemLayout} label="社交账号信息">
              {getFieldDecorator('socialAccount', {
                ...
                initialValue: detail.socialAccount,
