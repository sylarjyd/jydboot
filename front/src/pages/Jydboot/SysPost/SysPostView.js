...
import { SYSPOST_DETAIL } from '../../../actions/sysPost';
...
@Form.create()
class SysPostView extends PureComponent {
  componentWillMount() {
    const {
      dispatch,
      match: {
  ...
  handleEdit = () => {
    ...
    router.push(`/jydboot/sysPost/edit/${id}`);
  };
  ...
  render() {
    ...
    return (
      <Panel title="查看" back="/jydboot/sysPost" action={action}>
